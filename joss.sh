...
country=ID
state=Gebangkiidiw.com
locality=Youtube Gebangkiidiw
organization=Gretonger
organizationalunit=IT
commonname=www.gebangkiidiw.com
email=gebangkiidiw@gmail.com
...
echo 'echo -e "Script mod by Gebangkiidiw"' >> .bashrc
...
echo "<pre>Setup by Gebangkiidiw</pre>" > /home/vps/public_html/index.html
